...
- [VSCode Nativescript Extend](https://github.com/ehigiepaul/vscode-nativescript-extend) - This is Nativescript extended tool, which help create cross-platform mobile from snippets, fast context menu command and integrated emulator. for Visual Studio Code. **By [@ehigiepaul](https://twitter.com/ehigiepaul)**
